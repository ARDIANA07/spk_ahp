                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="p-5">
                            ...
                            <br><br>
                            <h1 class="h4 text-gray-900 mb-4">Login Sebagai Administrator</h1>
                            <br>
                        </div>
                        <?= $this->session->flashdata('message'); ?>

                            <form method="post" action="<?php echo base_url('login/aksi_login') ?> " class="user">
                            ...
                            <div class="text-center">
                                <a class="small" href="<?php echo base_url('auth/registration') ?>">Already have an account? Register!</a>
                            </div>
                        </div>
                    </div>
                </div>
